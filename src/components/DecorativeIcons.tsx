  ...
  <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <defs>
      <linearGradient id="gradient1" x1="8" y1="15" x2="52" y2="45" gradientUnits="userSpaceOnUse">
        <stop stopColor="#1e5f5a"/>
        <stop offset="1" stopColor="#2a8076"/>
      </linearGradient>
...
export const RocketIcon = memo(() => (
  <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g filter="url(#glow-rocket)">
      <path d="M30 10C30 10 40 15 45 25C50 35 50 40 50 40L40 50C40 50 35 50 25 45C15 40 10 30 10 30L20 20C20 20 25 15 30 10Z" stroke="url(#gradient-rocket)" strokeWidth="2.5" fill="rgba(30, 95, 90, 0.1)"/>
...
export const LightbulbIcon = memo(() => (
  <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g filter="url(#glow-bulb)">
      <path d="M30 10C22 10 16 16 16 24C16 29 19 33 22 36V42C22 44 24 46 26 46H34C36 46 38 44 38 42V36C41 33 44 29 44 24C44 16 38 10 30 10Z" stroke="url(#gradient-bulb)" strokeWidth="2.5" fill="rgba(30, 95, 90, 0.1)"/>
  ...
  <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <defs>
      <linearGradient id="gradient-sparkle" x1="5" y1="5" x2="35" y2="35" gradientUnits="userSpaceOnUse">
        <stop stopColor="#1e5f5a"/>
        <stop offset="0.5" stopColor="#1e5f5a"/>
        <stop offset="1" stopColor="#164541"/>
      </linearGradient>
