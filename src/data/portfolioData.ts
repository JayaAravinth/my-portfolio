...
export const skills: Skill[] = [
  {
    category: 'Languages',
    items: ['JavaScript', 'TypeScript', 'HTML5', 'CSS3', 'Core Java'],
  },
  {
    category: 'Frameworks & Libraries',
    items: ['React.js', 'Redux', 'Redux-Saga', 'TanStack Query', 'Material-UI', 'Styled Components'],
  },
  {
    category: 'Methodologies & Practices',
    items: ['Agile/Scrum', 'Responsive Web Design', 'UI/UX Best Practices', 'Component-Driven Development'],
  },
  {
